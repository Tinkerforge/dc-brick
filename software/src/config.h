...
#define PIN_STACK_INT0   {1 << 2, PIOA, ID_PIOB, PIO_INPUT, PIO_DEFAULT}
#define PIN_STACK_INT1   {1 << 5, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_STACK_INT2   {1 << 6, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
